...
namespace SharpLearning.Optimization
{
    ...
    public sealed class BayesianOptimizer : IOptimizer
    {
        ...
        private readonly int m_randomStartingPointsCount;
        private readonly int m_functionEvaluationsPerIterationCount;
        private readonly int m_randomSearchPointCount;
        ...
        private readonly RegressionExtremelyRandomizedTreesLearner m_learner;
        ...
        {
            var initialParameterSets = ProposeParameterSets(m_randomStartingPointsCount);
        ...
        ///     If no results are provided, random parameter sets will be returned.
        /// </param>
        /// <returns></returns>
        public double[][] ProposeParameterSets(
            ...
            IReadOnlyList<OptimizerResult> previousResults = null)
        {
            ...
            {
                var randomParameterSetCount = Math.Min(
                    parameterSetCount,
            ...
            var validParameterSets = previousResults
                ...
                .OrderBy(
                    v => v.Error
                ); // TODO: This might still fail to provide same order if two different parameter sets yield the same error.
        ...
        private double ComputeExpectedImprovement(double best, double[] parameterSet, RegressionForestModel model)
        {
