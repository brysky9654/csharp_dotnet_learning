...
namespace SharpLearning.Optimization
{
    ...
    public class SmacOptimizer : IOptimizer
    {
        ...
        /// <summary>
        /// Minimizes the provided function, returning the best result.
        /// </summary>
        ...
        /// <summary>
        /// Minimizes the provided function.  Returns all results, in chronological order.
        /// </summary>
        /// <param name="functionToMinimize"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Minimizes the provided function, returning the first result below the threshold.
        /// </summary>
        /// <param name="functionToMinimize"></param>
            ...
            IReadOnlyList<OptimizerResult> previousResults = null)
        {
            ...
            var validParameterSets = previousResults?.Where(v => !double.IsNaN(v.Error)).ToList();            
            
            var model = FitModel(validParameterSets);

            return GenerateCandidateParameterSets(parameterSetCount, validParameterSets, model);
        }
